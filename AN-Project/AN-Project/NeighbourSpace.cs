...
namespace AN_Project
{
    ...
    class MoveUpNeighbourSpace : INeighbourSpace<RecursiveTree<Node>>
    {
        ...
        public MoveUpNeighbourSpace(Random random)
        {
            Random = random;
        }
    ...
    class SplitNeighbourSpace : INeighbourSpace<RecursiveTree<Node>>
    {
        ...
        /// </summary>
        /// <param name="random">The random to be used</param>
        public SplitNeighbourSpace(Random random)
        {
            Random = random;
        }
    ...
    class MoveAndSplitNeighbourSpace : INeighbourSpace<RecursiveTree<Node>>
    {
        ...
        /// </summary>
        /// <param name="random">The random to be used</param>
        public MoveAndSplitNeighbourSpace(Random random)
        {
            Random = random;
            MoveUpNeighbourSpace = new MoveUpNeighbourSpace(Random);
        }
    ...
    class RandomMoveAndSplitNeighbourSpace : INeighbourSpace<RecursiveTree<Node>>
    {
        ...
        public RandomMoveAndSplitNeighbourSpace(Random random, int splits)
        {
            Random = random;
            Splits = splits;
            MoveUpNeighbourSpace = new MoveUpNeighbourSpace(Random);
            SplitNeighbourSpace = new SplitNeighbourSpace(Random);
        }
